...
func MarshalNodesCSV(g graph.Graph, propMap map[string]func(any) string, w io.Writer) error {
	out := csv.NewWriter(w)
...
func MarshalEdgesCSV(g graph.Graph, propMap map[string]func(any) string, w io.Writer) error {
	out := csv.NewWriter(w)
